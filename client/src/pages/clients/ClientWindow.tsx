...
import { createClient, updateClient, deleteClient, showClientsTable, getClients } from "../../actions/clients";
...
const ClientForm: React.FC<Props> = ({}) => {
  ...
  useEffect(() => {
    if (currentClient && whatToShow == "ClientWindow") {
      setOrgForm({
  ...
  return (
    <ClientFormWrapper>
      <HorizontalFlexDiv>
        <CenterH2>Client Overview </CenterH2>
      </HorizontalFlexDiv>
      ...
      <form>
        ...
        <StyledFormDiv>
          ...
          <ButtonDiv>
            ...
            <ButtonDivRightPart>
              <CreateButton onClick={viewProjects}>View Projects </CreateButton>
              <DeleteBtn onClick={deleteClient1}>Delete Client</DeleteBtn>
            </ButtonDivRightPart>
          </ButtonDiv>
        </StyledFormDiv>
      </form>
